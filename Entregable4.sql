...
/*No se puede eliminar gente de gerencia*/
CREATE OR REPLACE TRIGGER Eliminacion_Gerencia
BEFORE DELETE ON Empleados
FOR EACH ROW
BEGIN
	IF :OLD.departamento = 'Gerencia' THEN
		RAISE_APPLICATION_ERROR(-1002,'No se puede eliminar gente de gerencia')
	END IF;
END;
